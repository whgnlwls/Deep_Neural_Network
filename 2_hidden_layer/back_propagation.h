...
private:
	...
	double weight_H1toH2[NUM_OF_HID1_NODE][NUM_OF_HID2_NODE];
	double weight_H2toO[NUM_OF_HID2_NODE][NUM_OF_OUT_NODE];

	double weight_H1toH2_T[NUM_OF_HID2_NODE][NUM_OF_HID1_NODE];
	double weight_H2toO_T[NUM_OF_OUT_NODE][NUM_OF_HID2_NODE];
	...
	double net_H2[NUM_OF_HID2_NODE];
	double out_H2[NUM_OF_HID2_NODE];
	double del_H2[NUM_OF_HID2_NODE];
	double err_H2[NUM_OF_HID2_NODE];
